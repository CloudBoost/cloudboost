...
})(this, function(__WEBPACK_EXTERNAL_MODULE_42__, __WEBPACK_EXTERNAL_MODULE_66__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (_CB2.default._isNode) {
	    localStorage = __webpack_require__(41);
	}
	...
	var CloudApp = function () {
	    ...
	    _createClass(CloudApp, [{
	        ...
	        value: function init(serverUrl, applicationId, applicationKey, opts) {
	            ...
	            _CB2.default.CloudEvent.track('app loaded', { a: 1 });
	        }
	    }, {
	        key: 'onConnect',
	...
	var CloudQuery = function () {
	    ...
	    _createClass(CloudQuery, [{
	        ...
	        value: function find(callback) {
	            ...
	            //default sort added
	            if (Object.keys(thisObj.sort).length === 0 && thisObj.sort.constructor === Object) thisObj.sort = {
	                createdAt: 1
	            };
