...
class CloudObject extends React.Component {
    ...
    //     setTimeout(() => {
    //         $('.method-list').hide()
    //         $('<span class="morebtn buttn">more..</span>').insertAfter(".method-list");
 ...
 `}<span className="code-red">{`var`}</span>{` cloudObj = `}<span className="code-red">{`new`}</span>{` CB.CloudObject(`}<span className="code-yellow">{`"${TABLE}"`}</span>{`);`
                        ...
                        <CardTitle title="Constructor : CloudObject( columnName, [objectId] )" expandable={true} subtitle=" Instantiates a CloudObject object." />
...
cloudObj.save({
    ...
    error: `}<span className="code-red">{`function`}</span>{`(err) {
        //Error occured in saving object
                        ...
                        <CardTitle title="CloudObject.save( [callback] )" expandable={true}
    ...
    error: `}<span className="code-red">{`function`}</span>{`(err) {    
        //Error occurred in fetching data
                        ...
                        <CardTitle title="CloudObject.fetch( [callback] )" expandable={true}
    ...
    error: `}<span className="code-red">{`function`}</span>{`(err) {
        //Error
                        ...
                        <CardTitle title="CloudObject.delete( [callback] )" expandable={true}
