 ...
 */
                    ...
                    exports.storage = 'undefined' != typeof chrome && 'undefined' != typeof chrome.storage
 ...
 */
                        ...
                        exports.encodePayload = function(packets, supportsBinary, callback) {
                            ...
                            function encodeOne(packet, doneCallback) {
                                exports.encodePacket(packet, !isBinary
                                    ? false
                                    : supportsBinary, true, function(message) {
 ...
 */
                    ...
                    function Manager(uri, opts) {
                        ...
                        this.timeout(null == opts.timeout
                            ? 20000
                            : opts.timeout);
                        this.readyState = 'closed';
                        this.uri = uri;
 ...
 */
                        ...
                        function url(uri, loc) {
                            ...
                            // define href
                            obj.href = obj.protocol + '://' + host + (loc && loc.port == obj.port
                                ? ''
                                : (':' + obj.port));
 ...
 */
                    ...
                    function Backoff(opts) {
                        ...
                        this.jitter = opts.jitter > 0 && opts.jitter <= 1
                            ? opts.jitter
                            : 0;
                        this.attempts = 0;
                    }
                                ...
                                if (!has("json")) {
                                    ...
                                    if (!has("json-stringify")) {
                                        ...
                                        var quote = function(value) {
                                            ...
                                            var symbols = useCharIndex && (charIndexBuggy
                                                ? value.split("")
                                                : value);
                                            ...
                                            if (typeof value == "object" && value) {
                                                ...
                                                if (className == dateClass && !isProperty.call(value, "toJSON")) {
                                                    if (value > -1 / 0 && value < 1 / 0) {
                                                        ...
                                                        value = (year <= 0 || year >= 1e4
                                                            ? (year < 0
                                                                ? "-"
                                                                : "+") + toPaddedString(6, year < 0
                                                                ? -year
                                                                : year)
                                                            : toPaddedString(4, year)) + "-" + toPaddedString(2, month + 1) + "-" + toPaddedString(2, date) +
