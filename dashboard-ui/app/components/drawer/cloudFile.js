            ...
            <Card style={{ marginBottom: 16 }} onExpandChange={this.handleExpandChange}>
              ...
              <CardMedia>
                ...
                <div className='method-example' id='api-summary-example'>
                  <span className='pull-right flag fa fa-clipboard' title='Copy..' onClick={this.copyToClipboard('#pre_initiatecf')} />
...
var`}</span>{` file = `}<span className='code-red'>{`new `}</span>{`CB.CloudFile(documentFile);`
              ...
              <CardTitle title='Constructor : CloudFile( file/BLOB, typeOfFile )' expandable subtitle=' Instantiates a CloudFile object.' />
              <CardText expandable>
            ...
            <Card style={{ marginBottom: 16 }} onExpandChange={this.handleExpandChange}>
              ...
              <CardMedia>
                {/* overlay={<CardTitle title="Overlay title" subtitle="Overlay subtitle" />}
                        > */}
                <div className='method-example' id='api-summary-example'>
                  <span className='pull-right flag fa fa-clipboard' title='Copy..' onClick={this.copyToClipboard('#pre_savecf')} />
                  <pre id='pre_savecf'>
                    <span className='code-red'>{`var`}</span>{` documentFile = `}<span className='code-red'>{`new`}</span>{` Blob([`}<span className='code-yellow'>{`"'This is the content of 
    my document blob'`}</span>{`],{type :`}<span className='code-yellow'> {`'text/plain'}`}</span>{`});`}
                    <span className='code-red'>{`
...
file.save({
    ...
    error: `}<span className='code-red'>{`function`}</span>{`(err) {
        //error in uploading file
              ...
              <CardTitle title='CloudFile.save( [callback] )' expandable subtitle='Saves the CloudFile object.' />
              <CardText expandable>
                <div className='method-description'>
                  <div className='method-list'>
                    <h6>Arguments</h6>
            ...
            <Card style={{ marginBottom: 16 }} onExpandChange={this.handleExpandChange}>
              ...
              <CardMedia>
                {/* overlay={<CardTitle title="Overlay title" subtitle="Overlay subtitle" />}
                        > */}
                <div className='method-example' id='api-summary-example'>
                  <span className='pull-right flag fa fa-clipboard' title='Copy..' onClick={this.copyToClipboard('#pre_delcf')} />
                  <pre id='pre_delcf'>
    ...
    error: `}<span className='code-red'>{`function`}</span>{`(err) {
        //error in deleting file
              ...
              <CardTitle title='CloudFile.delete( [callback] )' expandable subtitle='Deletes the CloudFile object.' />
              <CardText expandable>
                <div className='method-description'>
                  <div className='method-list'>
                    <h6>Argument</h6>
            ...
            <Card style={{ marginBottom: 16 }} onExpandChange={this.handleExpandChange}>
              ...
              <CardMedia>
                {/* overlay={<CardTitle title="Overlay title" subtitle="Overlay subtitle" />}
                        > */}
                <div className='method-example' id='api-summary-example'>
                  <span className='pull-right flag fa fa-clipboard' title='Copy..' onClick={this.copyToClipboard('#pre_fetchcf')} />
                  <pre id='pre_fetchcf'>
                    <span className='code-red'>{
...
file.fetch({
    ...
    //error querying object
              ...
              <CardTitle title='CloudFile.fetch( [callback] ) ' expandable subtitle='Fetches the CloudFile object which has the URL along with other Properties of File.' />
              <CardText expandable>
                <div className='method-description'>
                  <div className='method-list'>
                    <h6>Argument</h6>
